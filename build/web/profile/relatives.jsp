...
<script>
    ...
    function redirect() {
        switch ($("#dataList").val().toUpperCase()) {
            case "USUARIO": window.location.replace("general.jsp"); break;  
            case "CORREO": window.location.replace("general.jsp"); break;  
            case "TIPO DE SANGRE": window.location.replace("general.jsp"); break;  
            case "DOMICILIO": window.location.replace("general.jsp"); break;   
            case "CONTACTOS DE EMERGENCIA": window.location.replace("emergencyContacts.jsp"); break;   
            case "FAMILIARES CERCANOS": window.location.replace("relatives.jsp"); break;   
            case "SEGURIDAD": window.location.replace("security.jsp"); break;   
            case "ENFERMEDADES": window.location.replace("healt.jsp"); break;   
            case "ALERGIAS": window.location.replace("healt.jsp"); break;   
            default: $("#dataList").val("");
        }
    }
</script>
