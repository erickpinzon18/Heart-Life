                    ...
                    <div class="container-fluid p-md-5 d-flex align-items-center h-100">
                        <div class="row justify-content-md-center">
                            <div class="col-md-8">
                                ...
                                <h1 class="  mb-5 pt-md-2 pt-sm-4">Somos empresa lí­der
                                    <br>en desarrollo de tecnologí­as.
                                </h1>
                                <p>Fundada como una agencia comercial de desarrollo de software, Heart Designs se convirtió rápidamente en una empresa
                                    lí­der en la programación y desarrollo de nuevas tecnologí­as que ahora opera en la zona del bají­o.
                                    En la década de 2020, la agencia comercial original se especializan en la producción de aplicaciones web y bases de datos.
                                    En la actualidad (2022), se pone en marcha la realización de su primer proyecto importante: Heart Life ©,
                                    la cual se encargará de revolucionar la forma en la que se ayuda a las personas de la tercera edad,
        ...
        <div class="row align-items-top text-center text-md-start">
            ...
            <div class="col-12 col-md-4 mt-5 mt-md-0 text-md-start">
                ...
                <p>Somos una empresa nacida en 2021, creada por 3 estudiantes que buscan generar
                    ...
                    ayudar a los sectores mas vulnerables poniendo en sus manos tecnologí­as sensillas y accesibles
